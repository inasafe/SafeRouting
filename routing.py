...
class SafeRouting:
    ...
    def __init__(self, iface):
        ...
        self.dlg = SafeRoutingDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&SafeRouting')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('SafeRouting', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/SafeRouting/icon.png'
        self.add_action(
            icon_path,
